    ...
    <SafeAreaView style={{flex: 1, backgroundColor: COLORS.white}}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <ImageBackground
          ...
          source={{uri:furniture ? furniture.imageUrl : ""}}>
          <View
            style={{
              height: 60,
              width: 70,
            ...
            <View
              ...
              <Text
                ...
                {furniture ? furniture.courselike : ""}
              </Text>
            </View>
            <Text
              style={{fontSize: 9, color: COLORS.white, fontWeight: 'bold'}}>
              {furniture ? furniture.activeparticipant: ""} Participant
            </Text>
          </View>
        </ImageBackground>
        ...
        <View style={style.detailsContainer}>
          <Text
            ...
            {furniture ? furniture.coursename : ""}
          </Text>
          <Text
            style={{
              marginVertical: 20,
          ...
          <Text style={{color: COLORS.dark, fontSize: 12, lineHeight: 20}}>
            {furniture ? furniture.longdescription : ""}
          </Text>
          <View
            style={{
              marginVertical: 20,
